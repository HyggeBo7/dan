package top.dearbo.frame.common.test.proxy;

import top.dearbo.frame.common.test.proxy.jdk.JdkInvocationHandler;
import top.dearbo.frame.common.test.proxy.service.OrderService;
import top.dearbo.frame.common.test.proxy.service.impl.OrderServiceImpl;
